...
local isnetworkowner = identifyexecutor and table.find({'AWP', 'Nihon', 'Codex', 'Delta', 'Cyptic', 'Zeno', 'Krampus', 'Fusion'}, ({identifyexecutor()})[1]) and isnetworkowner or function()
	return true
end
	...
	function whitelist:update(first)
		local suc = pcall(function()
			local _, subbed = pcall(function()
				return game:HttpGet('https://github.com/hijsys/whitelists')
			end)
			local commit = subbed:find('currentOid')
			commit = commit and subbed:sub(commit + 13, commit + 52) or nil
			commit = commit and #commit == 40 and commit or 'main'
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/hijsys/whitelists/'..commit..'/PlayerWhitelist.json', true)
		end)
